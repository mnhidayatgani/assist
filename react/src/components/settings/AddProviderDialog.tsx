...
const PROVIDER_OPTIONS = [
  ...
  },
  {
    ...
    data: {
        ...
        models: {
                'seed-1-6-250915': { type: 'image' },
                'seed-1-6-flash-250715': { type: 'text' },
                'deepseek-r1-250528': { type: 'text'},
                'skylark-pro-250415': { type: 'text'},
                'skylark-skylark-lite-250215': { type: 'text'},
                'seedream-4-0-250828': { type: 'image'},
                'seedream-3-0-t2i-250415': { type: 'image'},
                'seededit-3-0-i2i-250628': { type: 'image'},
